...
variable "primary_db_arn"     { type = string; description = "Primary RDS ARN for read replica source" }
variable "primary_velero_bucket_arn" { type = string; description = "Primary Velero S3 bucket ARN (for CRR)" }
